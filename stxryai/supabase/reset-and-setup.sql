-- StxryAI Database Setup Script
-- This script will safely set up the database schema
-- Run this in Supabase SQL Editor

-- First, drop existing tables if they exist (in correct order to avoid dependency errors)
DROP TRIGGER IF EXISTS on_auth_user_created ON auth.users;
DROP TRIGGER IF EXISTS update_story_stats_trigger ON chapters;
...
DROP FUNCTION IF EXISTS update_story_stats();
...
DROP TABLE IF EXISTS collection_stories CASCADE;
