...
export type RelationshipType = 'ally' | 'enemy' | 'family' | 'romantic' | 'mentor' | 'rival' | 'neutral' | 'complicated';
export type CanonLockLevel = 'suggestion' | 'soft' | 'hard' | 'immutable';
export type WorldElementType = 'geography' | 'culture' | 'religion' | 'magic_system' | 'technology' | 'political' | 'economic' | 'historical' | 'myth' | 'custom';
...
export interface PersistentCharacter {
  ...
  // Role
  characterRole: 'protagonist' | 'antagonist' | 'deuteragonist' | 'supporting' | 'minor' | 'background';
...
export interface RevisionRequest {
  ...
  // Propagation
  propagationStatus: 'pending' | 'analyzing' | 'ready' | 'in_progress' | 'completed' | 'failed' | 'cancelled';
