...
export const storyStarters: StoryStarter[] = [
  // Fantasy
  {
    ...
    genre: 'Fantasy',
    prompt: 'You discover you\'re the last person who can speak to dragons. They need your help to prevent an ancient war.',
  ...
  },
  {
    ...
    genre: 'Fantasy',
    prompt: 'The royal crown has been stolen, and you, a common thief, are framed for it. Clear your name or claim the throne.',
  ...
  },
  {
    ...
    title: 'Mirror Worlds',
    genre: 'Fantasy',
    prompt: 'Every choice creates a mirror world. You can see them all, and now they\'re starting to collide.',
  ...
  // Sci-Fi
  {
    ...
    prompt: 'You receive a message from yourself, sent from 10 years in the future. It says: "Don\'t trust anyone. Especially not me."',
  ...
  },
  {
    ...
    genre: 'Science Fiction',
    prompt: 'You wake from cryosleep to find the ship off-course and the crew missing. You have 48 hours before life support fails.',
  ...
  },
  {
    ...
    genre: 'Science Fiction',
    prompt: 'You discover reality is a simulation, but the administrators offer you a deal: forget what you know, or join their resistance.',
  ...
  // Mystery
  {
    ...
    genre: 'Mystery',
    prompt: 'A famous magician disappears during their final trick. The police think it\'s publicity. You know better.',
  ...
  },
  {
    ...
    genre: 'Mystery',
    prompt: 'Reopening a 20-year-old murder case, you discover the original detective\'s notes contain hidden messages.',
  ...
  },
  {
    ...
    genre: 'Mystery',
    prompt: 'Five strangers are invited to a dinner party. One by one, they reveal they all have a connection to an unsolved crime.',
  ...
  // Romance
  {
    ...
    genre: 'Romance',
    prompt: 'Returning to your hometown after 10 years, you run into your high school sweetheart. They never left.',
  ...
  },
  {
    ...
    genre: 'Romance',
    prompt: 'To inherit your grandmother\'s estate, you must be married. Your best friend volunteers to fake it. Feelings get real.',
  ...
  },
  {
    ...
    genre: 'Romance',
    prompt: 'You don\'t speak each other\'s languages, but somehow you understand everything that matters.',
  ...
  // Horror
  {
    ...
    genre: 'Horror',
    prompt: 'Your childhood home is being demolished. But the house has memories it wants to keep. Violent memories.',
  ...
  },
  {
    ...
    genre: 'Horror',
    prompt: 'A new disease makes people smile constantly. But behind those smiles, something is very, very wrong.',
  ...
  // Thriller
  {
    ...
    genre: 'Thriller',
    prompt: 'You witness a murder, but when you try to report it, the victim is alive and has no memory of you.',
  ...
  },
  {
    ...
    title: '72 Hours',
    genre: 'Thriller',
    prompt: 'Your phone shows a countdown: 72 hours. A text arrives: "You know what you did. Make it right, or everyone knows."',
  ...
  },
  {
    ...
    title: 'The Passenger',
    genre: 'Thriller',
    prompt: 'You offer a stranger a ride in a storm. They know your name. Your address. Your secrets.',
  ...
  // Adventure
  {
    ...
    genre: 'Adventure',
    prompt: 'Your grandfather\'s journal reveals coordinates to an island that doesn\'t appear on any map.',
  ...
  },
  {
    ...
    genre: 'Adventure',
    prompt: 'You enter a competition to circumnavigate the globe using only $100 and no technology.',
  ...
  // Drama
  {
    ...
    title: 'The Letter',
    genre: 'Drama',
    prompt: 'Your mother leaves you a letter to be opened after her death. It reveals you have a sibling you never knew about.',
  ...
  },
  {
    ...
    genre: 'Drama',
    prompt: 'A legendary actor announces their retirement with one final show. You\'re chosen to co-star. They\'re impossible to work with.',
  ...
  },
  {
    ...
    title: 'The Reunion',
    genre: 'Drama',
    prompt: 'Your high school class reunion brings together five friends who haven\'t spoken in 20 years. For good reason.',
 ...
 */
export function getStartersByDifficulty(difficulty: 'easy' | 'medium' | 'challenging'): StoryStarter[] {
