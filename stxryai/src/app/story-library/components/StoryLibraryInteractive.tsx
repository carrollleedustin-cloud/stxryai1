        ...
        <div className="container-void">
          ...
          <TemporalReveal className="text-center mb-12">
            ...
            <p className="font-prose text-lg text-text-tertiary max-w-2xl mx-auto">
              Discover infinite narratives waiting to be explored. Every story branches into
          ...
          {error && (
            <TemporalReveal>
              <div className="text-center py-12">
                ...
                <SpectralButton onClick={() => loadStories(true)}>Try Again</SpectralButton>
              </div>
            </TemporalReveal>
          )}
                      ...
                      >
                        ...
                        <div className="p-5">
                          ...
                          <p className="text-sm text-text-tertiary mb-1">
                            by{' '}
                            <span className="text-spectral-cyan">
                              {story.author?.display_name || 'Unknown'}
                            </span>
                          </p>
