  ...
  return (
    <div className="min-h-screen bg-void-950 py-8">
      <div className="container mx-auto px-4 max-w-4xl">
        <h1 className="text-4xl font-bold mb-6 text-void-100">Cookie Policy</h1>
        <p className="text-sm text-void-400 mb-8">
          Last updated: January 1, 2024
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-spectral-cyan">1. What Are Cookies?</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-spectral-cyan">2. Types of Cookies We Use</h2>

          <h3 className="text-xl font-semibold mb-3 mt-4 text-spectral-violet">2.1 Essential Cookies</h3>
          <p className="text-void-300">
          ...
          <h3 className="text-xl font-semibold mb-3 mt-6 text-spectral-violet">2.2 Functional Cookies</h3>
          <p className="text-void-300">
          ...
          <h3 className="text-xl font-semibold mb-3 mt-6 text-spectral-violet">2.3 Analytics Cookies</h3>
          <p className="text-void-300">
          ...
          <h3 className="text-xl font-semibold mb-3 mt-6 text-spectral-violet">2.4 Advertising Cookies</h3>
          <p className="text-void-300">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-spectral-cyan">3. Third-Party Cookies</h2>
          <p className="text-void-300">We use services from third parties that may set cookies on your device:</p>
          <ul className="list-disc pl-6 mt-4 text-void-300 space-y-2">
            <li>
              <strong className="text-void-200">Google Analytics:</strong> Website analytics and usage tracking
            </li>
            <li>
              <strong className="text-void-200">Google AdSense:</strong> Advertising services (free users only)
            </li>
            <li>
              <strong className="text-void-200">PostHog:</strong> Product analytics and user behavior tracking
            </li>
            <li>
              <strong className="text-void-200">Supabase:</strong> Authentication and database services
            </li>
            <li>
              <strong className="text-void-200">Stripe:</strong> Payment processing (when making purchases)
            </li>
          </ul>
          <p className="mt-4 text-void-300">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-spectral-cyan">4. Managing Cookies</h2>
          <p className="text-void-300">You have several options for managing cookies:</p>

          <h3 className="text-xl font-semibold mb-3 mt-6 text-spectral-violet">4.1 Browser Settings</h3>
          <p className="text-void-300">
          ...
          <p className="mt-4 text-void-300">Browser-specific instructions:</p>
          <ul className="list-disc pl-6 mt-4 text-void-300 space-y-2">
            <li>
              <a
          ...
          <h3 className="text-xl font-semibold mb-3 mt-6 text-spectral-violet">4.2 Opt-Out Tools</h3>
          <p className="text-void-300">You can opt out of certain tracking through these tools:</p>
          <ul className="list-disc pl-6 mt-4 text-void-300 space-y-2">
            <li>
              <a
                href="https://tools.google.com/dlpage/gaoptout"
          ...
          <h3 className="text-xl font-semibold mb-3 mt-6 text-spectral-violet">4.3 Account Settings</h3>
          <p className="text-void-300">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-spectral-cyan">5. Do Not Track Signals</h2>
          <p className="text-void-300">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-spectral-cyan">6. Changes to This Cookie Policy</h2>
          <p className="text-void-300">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-spectral-cyan">7. Contact Us</h2>
          <p className="text-void-300">If you have questions about our use of cookies, please contact us:</p>
