  ...
  return (
    <div className="min-h-screen bg-void-950 py-8">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-spectral-cyan">6. Data Retention</h2>
          <p className="text-void-300">We retain your information for as long as necessary to:</p>
          <ul className="list-disc pl-6 mt-4 text-void-300 space-y-2">
        ...
        <section className="mb-8">
          ...
          <ul className="list-none pl-0 mt-4 text-void-300 space-y-2">
            ...
            <li>
              <strong className="text-void-200">Data Protection Officer:</strong> dpo@stxryai.com
            </li>
          </ul>
        </section>
      </div>
