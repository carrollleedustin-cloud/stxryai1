  ...
  const testimonials: Testimonial[] = [
    {
      ...
      rating: 5,
      comment:
        "The AI-generated stories are incredibly immersive. I've never experienced interactive fiction like this before. Every choice feels meaningful and the narratives are genuinely unpredictable.",
      storiesRead: 47,
    },
    {
      name: 'Marcus Chen',
      ...
      rating: 5,
      comment:
        'As a writer, the AI writing assistant has transformed my creative process. The collaborative tools make it easy to work with other authors, and the analytics help me understand what readers love.',
      storiesRead: 89,
    },
    {
      ...
      rating: 5,
      comment:
        "I started with the free plan and was hooked immediately. The community features are amazing - I've made friends who share my love for dark fantasy stories. Upgraded to premium after just one week!",
      storiesRead: 23,
    },
  ];
