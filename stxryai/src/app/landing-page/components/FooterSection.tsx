    ...
    <footer className="relative border-t border-membrane">
      ...
      <div className="container-void py-16">
          ...
          <div className="col-span-2 lg:col-span-2">
            <Link href="/" className="inline-flex items-center gap-3 mb-6">
              <svg width="32" height="32" viewBox="0 0 36 36" fill="none">
                <path d="M18 2L4 10v16l14 8 14-8V10L18 2z" fill="url(#footer-logo-gradient)" />
              ...
              <span className="font-display text-lg tracking-widest text-text-primary">STXRY</span>
            </Link>

            <p className="font-prose text-sm text-text-tertiary max-w-xs mb-8 leading-relaxed">
              Where infinite stories await. AI-powered interactive fiction that adapts to your
              choices.
            </p>
        ...
        <div className="mt-16 pt-8 border-t border-membrane flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-text-ghost">© {currentYear} Stxryai. All rights reserved.</p>
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse at center bottom, rgba(0, 245, 212, 0.05) 0%, transparent 70%)',
        }}
      />
    </footer>
  );
