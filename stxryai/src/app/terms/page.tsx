  ...
  return (
    <div className="min-h-screen bg-void-950 py-8">
      <div className="container mx-auto px-4 max-w-4xl">
        <h1 className="text-4xl font-bold mb-6 text-void-100">Terms of Service</h1>
        ...
        <div className="bg-yellow-900/30 border border-yellow-700 rounded-lg p-4 mb-8">
          <p className="text-sm text-yellow-300">
            <strong className="text-yellow-200">Legal Notice:</strong> This is a template Terms of Service. Please review with legal counsel before
            launching to production. Customize all sections to match your specific business model and jurisdiction.
          </p>
        </div>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-spectral-cyan">1. Acceptance of Terms</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-spectral-cyan">2. Description of Service</h2>
          <p className="text-void-300">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-spectral-cyan">3. User Accounts</h2>
          <h3 className="text-xl font-semibold mb-3 mt-4 text-spectral-violet">3.1 Account Creation</h3>
          <p className="text-void-300">
          ...
          <h3 className="text-xl font-semibold mb-3 mt-6 text-spectral-violet">3.2 Account Security</h3>
          <p className="text-void-300">
            You are responsible for maintaining the confidentiality of your account credentials and for all activities
            that occur under your account. You agree to notify us immediately of any unauthorized use of your account.
          </p>

          <h3 className="text-xl font-semibold mb-3 mt-6 text-spectral-violet">3.3 Age Requirements</h3>
          <p className="text-void-300">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-spectral-cyan">4. User Content and Intellectual Property</h2>
          <h3 className="text-xl font-semibold mb-3 mt-4 text-spectral-violet">4.1 Your Content</h3>
          <p className="text-void-300">
          ...
          <h3 className="text-xl font-semibold mb-3 mt-6 text-spectral-violet">4.2 Content Standards</h3>
          <p className="text-void-300">You agree not to post, upload, or transmit any User Content that:</p>
          <ul className="list-disc pl-6 mt-4 text-void-300 space-y-2">
          ...
          <h3 className="text-xl font-semibold mb-3 mt-6 text-spectral-violet">4.3 Content Moderation</h3>
          <p className="text-void-300">
          ...
          <h3 className="text-xl font-semibold mb-3 mt-6 text-spectral-violet">4.4 AI-Generated Content</h3>
          <p className="text-void-300">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-spectral-cyan">5. Premium Features and Payments</h2>
          <h3 className="text-xl font-semibold mb-3 mt-4 text-spectral-violet">5.1 Subscription Plans</h3>
          <p className="text-void-300">
          ...
          <h3 className="text-xl font-semibold mb-3 mt-6 text-spectral-violet">5.2 Payment Terms</h3>
          <p className="text-void-300">
          ...
          <h3 className="text-xl font-semibold mb-3 mt-6 text-spectral-violet">5.3 Cancellation</h3>
          <p className="text-void-300">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-spectral-cyan">6. Prohibited Uses</h2>
          <p className="text-void-300">You agree not to use the Service:</p>
          <ul className="list-disc pl-6 mt-4 text-void-300 space-y-2">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-spectral-cyan">7. Intellectual Property Rights</h2>
          <p className="text-void-300">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-spectral-cyan">8. Disclaimers and Limitation of Liability</h2>
          <h3 className="text-xl font-semibold mb-3 mt-4 text-spectral-violet">8.1 Service Availability</h3>
          <p className="text-void-300">
            The Service is provided &quot;as is&quot; and &quot;as available&quot; without warranties of any kind,
            either express or implied. We do not guarantee that the Service will be uninterrupted, secure, or error-free.
          </p>

          <h3 className="text-xl font-semibold mb-3 mt-6 text-spectral-violet">8.2 AI Content Disclaimer</h3>
          <p className="text-void-300">
          ...
          <h3 className="text-xl font-semibold mb-3 mt-6 text-spectral-violet">8.3 Limitation of Liability</h3>
          <p className="text-void-300">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-spectral-cyan">9. Indemnification</h2>
          <p className="text-void-300">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-spectral-cyan">10. Termination</h2>
          <h3 className="text-xl font-semibold mb-3 mt-4 text-spectral-violet">10.1 Termination by You</h3>
          <p className="text-void-300">You may terminate your account at any time by contacting us or using account deletion features.</p>

          <h3 className="text-xl font-semibold mb-3 mt-6 text-spectral-violet">10.2 Termination by Us</h3>
          <p className="text-void-300">
          ...
          <h3 className="text-xl font-semibold mb-3 mt-6 text-spectral-violet">10.3 Effect of Termination</h3>
          <p className="text-void-300">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-spectral-cyan">11. Changes to Terms</h2>
          <p className="text-void-300">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-spectral-cyan">12. Governing Law and Dispute Resolution</h2>
          <p className="text-void-300">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-spectral-cyan">13. Contact Information</h2>
          <p className="text-void-300">
            If you have any questions about these Terms, please contact us at:
          </p>
          <ul className="list-none pl-0 mt-4 text-void-300 space-y-2">
            <li><strong className="text-void-200">Email:</strong> legal@stxryai.com</li>
            <li><strong className="text-void-200">Support:</strong> support@stxryai.com</li>
          </ul>
        </section>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-spectral-cyan">14. Severability</h2>
          <p className="text-void-300">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-spectral-cyan">15. Entire Agreement</h2>
          <p className="text-void-300">
