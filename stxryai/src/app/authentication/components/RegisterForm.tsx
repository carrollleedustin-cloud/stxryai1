    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="space-y-3">
        ...
        <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
          <p className="text-xs text-blue-800">
            <strong>Family-Friendly Platform:</strong> StxryAI welcomes readers of all ages! We
            offer content from children's stories to adult fiction. Age-appropriate content
            filtering is available in your account settings.
          </p>
        </div>
      </div>
      ...
      <div className="space-y-3">
        ...
        <button
          ...
          disabled={isLoadingState}
          className="w-full flex items-center justify-center gap-3 bg-[#5865F2] text-white py-3 px-4 rounded-lg hover:bg-[#4752C4] transition-colors disabled:bg-[#5865F2]/50 disabled:cursor-not-allowed"
        >
