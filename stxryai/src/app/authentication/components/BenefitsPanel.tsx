...
const BenefitsPanel = () => {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h2 className="font-heading text-3xl font-bold text-foreground mb-2">Welcome to Stxryai</h2>
      ...
      <div>
        <h3 className="text-lg font-semibold text-foreground mb-4">Featured Stories</h3>
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4">
                <div className="flex items-center justify-between mb-1">
                  ...
                  <div className="flex items-center space-x-1">
                    ...
                    <span className="text-xs font-semibold text-foreground">{story.rating}</span>
                  </div>
                </div>
