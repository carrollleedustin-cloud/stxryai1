...
const recentActivity = [
  {
    kid: 'Emma',
    action: 'Read "The Dragon Who Lost His Fire"',
    time: '2 hours ago',
    type: 'story',
    duration: '12 min',
  },
  ...
  {
    kid: 'Liam',
    action: 'Read "Robot Best Friends"',
    time: 'Yesterday',
    type: 'story',
    duration: '15 min',
  },
  ...
  {
    kid: 'Emma',
    action: 'Read "Princess Astro Goes to Space"',
    time: '2 days ago',
    type: 'story',
    duration: '8 min',
  },
  {
    kid: 'Liam',
    action: 'Read "The Magical Garden"',
    time: '2 days ago',
    type: 'story',
    duration: '12 min',
  },
          ...
          {[
            {
              ...
              value: monthlyStats.totalReadingTime,
              color: 'cyan',
            },
            {
              icon: BookOpen,
              label: 'Stories Completed',
              value: monthlyStats.storiesCompleted,
              color: 'pink',
            },
            {
              icon: Target,
              label: 'Games Played',
              value: monthlyStats.gamesPlayed,
              color: 'purple',
            },
            {
              icon: Award,
              label: 'Badges Earned',
              value: monthlyStats.badgesEarned,
              color: 'gold',
            },
          ].map((stat, i) => (
            <motion.div
            ...
            <div className="space-y-4">
              {learningInsights.map((insight, i) => (
                ...
                >
                  ...
                  <span
                    className={`text-lg font-bold ${insight.positive ? 'text-green-400' : 'text-red-400'}`}
                  >
                    {insight.value}
                  </span>
                </motion.div>
