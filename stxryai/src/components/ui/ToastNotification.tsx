 ...
 * Beautiful, animated toast notifications with icons
 */
...
function ToastItem({ toast, onClose }: { toast: Toast; onClose: () => void }) {
  ...
  return (
    <motion.div
      ...
      className={`${style.bg} ${style.border} border rounded-lg shadow-lg p-4 backdrop-blur-sm flex items-start gap-3 min-w-[320px]`}
    >
      {/* Icon */}
      ...
      <div className="flex-1">
        ...
        {toast.description && (
          <p className={`text-sm mt-1 ${style.text} opacity-90`}>{toast.description}</p>
        )}
      </div>
