      ...
      <>
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div
            ...
            style={{
              background:
                'radial-gradient(ellipse at center, rgba(0, 245, 212, 0.08) 0%, transparent 70%)',
            }}
          />
          <div
            ...
            style={{
              background:
                'radial-gradient(ellipse at center, rgba(123, 44, 191, 0.08) 0%, transparent 70%)',
            }}
          />
        </div>
      </>
      ...
      <>
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div
            ...
            style={{
              background:
                'radial-gradient(ellipse at center, rgba(0, 245, 212, 0.12) 0%, transparent 70%)',
            }}
          />
          <div
            ...
            style={{
              background:
                'radial-gradient(ellipse at center, rgba(123, 44, 191, 0.1) 0%, transparent 70%)',
            }}
          />
          <div
      ...
      <>
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div
            ...
            style={{
              background:
                'radial-gradient(ellipse at center, rgba(0, 245, 212, 0.05) 0%, transparent 70%)',
            }}
          />
          <div
            ...
            style={{
              background:
                'radial-gradient(ellipse at center, rgba(123, 44, 191, 0.04) 0%, transparent 70%)',
            }}
          />
        </div>
      </>
