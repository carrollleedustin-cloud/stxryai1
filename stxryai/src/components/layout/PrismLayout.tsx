  ...
  return (
    <div className="relative min-h-screen w-full overflow-x-hidden bg-slate-950 text-slate-200 selection:bg-fuchsia-500/30 selection:text-fuchsia-200 font-sans">
      ...
      <div className="fixed inset-0 z-0 opacity-40 pointer-events-none overflow-hidden">
        <div className="absolute top-[-10%] left-[-10%] h-[50vh] w-[50vw] rounded-full bg-violet-600/20 blur-[120px] mix-blend-screen animate-float" style={{ animationDuration: '25s' }} />
        <div className="absolute bottom-[-10%] right-[-10%] h-[50vh] w-[50vw] rounded-full bg-fuchsia-600/20 blur-[120px] mix-blend-screen animate-float" style={{ animationDuration: '30s', animationDelay: '-10s' }} />
        <div className="absolute top-[40%] left-[30%] h-[40vh] w-[40vw] rounded-full bg-cyan-600/10 blur-[100px] mix-blend-screen animate-pulse" style={{ animationDuration: '15s' }} />
      </div>
